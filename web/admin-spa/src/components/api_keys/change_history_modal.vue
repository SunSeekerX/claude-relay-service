<template>
  <ModalTransition @after-leave="onClosed">
    <div v-if="visible" class="modal fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        class="modal-content mx-auto flex max-h-[90vh] w-full max-w-2xl flex-col p-3 dark:bg-gray-800 sm:p-4"
      >
        <div class="mb-5 flex items-center justify-between">
          <div class="min-w-0">
            <div class="flex items-center gap-3">
              ...
              >
                <i class="i-lucide-scroll-text text-white" />
              </div>
              <div class="min-w-0">
        ...
        <div class="modal-scroll-content custom-scrollbar flex-1">
          ...
          >
            <i class="i-lucide-inbox mb-3 text-3xl text-gray-300 dark:text-gray-600" />
          ...
          <div v-else class="space-y-3">
            ...
            >
              <div class="mb-2 flex flex-wrap items-center justify-between gap-2">
                ...
                >
                  <i :class="[actionIcon(item.action), 'mr-1.5']" />
        ...
        <div class="flex shrink-0 items-center gap-2 border-t border-gray-200 pt-3 dark:border-gray-700 mt-4">
          <button
...
const actionIcon = (action) => {
  if (action === 'add_cost_limit') return 'i-lucide-dollar-sign'
  if (action === 'extend_expiry') return 'i-lucide-clock'
  if (action === 'enable') return 'i-lucide-circle-check'
  if (action === 'disable') return 'i-lucide-ban'
