<template>
      ...
      >
        ...
        >
          <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">
            <i class="i-lucide-tags mr-2 text-purple-500" />
            标签管理
          </h3>
          <button
        ...
        <div class="max-h-[60vh] overflow-y-auto px-6 py-4">
          ...
          <div class="mb-4 flex gap-2">
            ...
            <button
              ...
              @click="createTag"
            >
              <i v-if="creating" class="i-lucide-loader-circle animate-spin mr-1" />
              <i v-else class="i-lucide-plus mr-1" />
              新增
            </button>
          </div>

          <div v-if="loading" class="py-5 text-center">
            <i class="i-lucide-loader-circle animate-spin text-2xl text-gray-400" />
            <p class="mt-2 text-gray-500 dark:text-gray-400">加载中...</p>
          </div>

          <div v-else-if="tags.length === 0" class="py-5 text-center">
            <i class="i-lucide-tag text-4xl text-gray-300 dark:text-gray-600" />
          ...
          <div v-else class="space-y-2">
            ...
            >
              <div class="flex items-center gap-3">
                <i class="i-lucide-tag text-purple-500" />
  ...
  <ModalTransition>
    ...
    >
      <div class="modal-panel w-full max-w-md rounded-2xl bg-white p-4 shadow-2xl dark:bg-gray-800">
        ...
        <div class="flex justify-end gap-3">
          ...
          <button
            ...
            @click="executeRename"
          >
            <i v-if="processing" class="i-lucide-loader-circle animate-spin mr-1" />
            确定
          </button>
        </div>
      </div>
