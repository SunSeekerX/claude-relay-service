<template>
  <ModalTransition>
    <div
      v-if="show"
      class="record-detail-modal fixed inset-0 z-[1200] flex items-start justify-center overflow-y-auto bg-black/40 p-4 pt-[10vh]"
      @click.self="emitClose"
    >
      <div
        class="modal-content w-full max-w-[720px] rounded-2xl bg-white shadow-xl dark:bg-gray-900"
      >
    ...
    <div class="flex justify-end border-t border-gray-200 px-5 py-4 dark:border-gray-700">
        <button class="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700" type="button" @click="emitClose">关闭</button>
      </div>
      </div>
    </div>
  </ModalTransition>
