        ...
        >
          ...
          >
            <div class="mb-3 flex items-center gap-2">
              ...
              >
                <i class="i-lucide-sliders-horizontal text-sm text-white" />
              </div>
              <h4 class="text-sm font-semibold text-gray-800 dark:text-gray-200">
                  ...
                  >
                    ...
                    <div class="mt-3">
                      ...
                      <textarea
                        ...
                        v-model="rule.value"
                        class="form-input w-full resize-y border-transparent font-mono text-sm dark:border-transparent dark:bg-gray-700 dark:text-gray-200 dark:placeholder-gray-400"
