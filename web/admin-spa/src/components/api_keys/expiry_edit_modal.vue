<template>
  <ModalTransition>
    <div v-if="show" class="modal fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <!-- 模态框内容 -->
      <div class="modal-content relative mx-auto w-full max-w-lg p-4">
        <!-- 头部 -->
              ...
              <div>
                ...
                <p class="text-sm font-semibold text-gray-800 dark:text-gray-200">
                  ...
                  <template v-if="apiKey.expirationMode === 'activation' && !apiKey.isActivated">
                    <i class="i-lucide-circle-pause mr-1 text-blue-500" />
                    未激活
                  ...
                  <!-- 永不过期 -->
                  <template v-else>
                    <i class="i-lucide-infinity mr-1 text-gray-500" />
                    永不过期
                  </template>
                </p>
              </div>
            ...
            <div class="flex items-center justify-between">
              <div>
                <p class="mb-1 text-sm font-medium text-blue-700 dark:text-blue-400">
                  <i class="i-lucide-arrow-right mr-1" />
                  新的过期时间
                </p>
              ...
              <div
                class="flex h-12 w-12 items-center justify-center rounded-lg bg-white shadow-sm dark:bg-gray-700"
              >
                <i class="i-lucide-check text-lg text-green-500" />
              </div>
            </div>
          </div>
