      ...
      >
        ...
        <div class="mb-3 flex items-center justify-between">
          <div class="flex min-w-0 items-center gap-2">
            ...
            >
              <i class="i-lucide-chart-line text-sm text-white" />
            </div>
        ...
        <div class="modal-scroll-content custom-scrollbar flex-1 overflow-y-auto">
          ...
          <div v-if="hasLimits" class="mb-4">
            ...
            >
              <i class="i-lucide-shield mr-2 text-red-500" />
              限制设置
            </h4>
            <div class="space-y-3 rounded-lg bg-gray-50 p-3 dark:bg-gray-700/50">
              ...
              <div v-if="hasAccessRestrictions" class="space-y-2">
                <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  <i class="i-lucide-lock mr-1 text-gray-500" />
                  访问控制
                </h5>
...
import LimitProgressBar from './limit_progress_bar.vue'
import WindowCountdown from './window_countdown.vue'

import { formatCost, formatNumber } from '@/libs/tools'
