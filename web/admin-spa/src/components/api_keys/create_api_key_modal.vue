      ...
      <div class="modal-content mx-auto flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden p-2.5 sm:p-3">
        <div class="mb-2.5 flex items-center justify-between sm:mb-3">
          <div class="flex items-center gap-2 sm:gap-3">
            ...
            >
              <i class="i-lucide-key text-sm text-white sm:text-base" />
            </div>
        ...
        >
          ...
          >
            ...
            <div v-if="form.createType === 'batch'" class="mt-3">
                ...
                <div class="flex-1">
                  ...
                  <div class="flex items-center gap-2">
                    <input
                      ...
                      class="form-input w-full border-transparent text-sm dark:border-transparent dark:bg-gray-700 dark:text-gray-200 dark:placeholder-gray-400"
                      max="500"
                      min="2"
              ...
              <p class="mt-2 flex items-start text-sm text-amber-600 dark:text-amber-400">
                <i class="i-lucide-info mr-1 mt-0.5 flex-shrink-0" />
                <span
          ...
          <div>
            ...
            <div>
              <input
                v-model="form.name"
                class="form-input flex-1 border-transparent text-sm dark:border-transparent dark:bg-gray-700 dark:text-gray-200 dark:placeholder-gray-400"
            ...
            <div v-if="enableServiceRates" class="mt-3 space-y-2">
              ...
              >
                ...
                <input
                  ...
                  class="form-input w-24 border-transparent text-sm dark:border-transparent dark:bg-gray-700 dark:text-gray-200"
                  min="0"
                  placeholder="1.0"
                  step="0.1"
                  type="number"
          ...
          <div class="flex shrink-0 items-center gap-2 border-t border-gray-200 pt-2 dark:border-gray-700">
            ...
            >
              ...
              <i v-else class="i-lucide-plus mr-2" />
              {{ loading ? '创建中...' : '创建' }}
            </button>
          </div>
        </form>
...
const createTypeOptions = [
  { value: 'single', label: '单个创建', description: '创建一个 API Key', icon: 'i-lucide-key' },
  { value: 'batch', label: '批量创建', description: '一次创建多个 Key', icon: 'i-lucide-layers' }
]

const expirationModeOptions = [
  {
    value: 'fixed',
    label: '固定时间过期',
    description: '创建后立即生效，按设定时间过期',
    icon: 'i-lucide-calendar'
  },
  {
    value: 'activation',
    label: '首次使用后激活',
    description: '首次使用时激活，适合批量销售',
    icon: 'i-lucide-zap'
  }
]
