<template>
  <ModalTransition @after-leave="onClosed">
    <div v-if="visible" class="modal fixed inset-0 z-50 flex items-center justify-center p-4">
      <div class="modal-content mx-auto flex max-h-[90vh] w-full max-w-md flex-col p-4">
        <div class="mb-3 flex items-center justify-between">
          <div class="flex items-center gap-3">
            <div
              class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-green-500 to-green-600"
            >
              <i class="i-lucide-clock text-white" />
            </div>
            <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100">续期 API Key</h3>
          </div>
          <button
        ...
        <div class="modal-scroll-content custom-scrollbar flex-1 space-y-3">
          <div
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div>
                <h4 class="mb-1 font-semibold text-gray-800 dark:text-gray-100">API Key 信息</h4>
          ...
          <div>
            ...
            <p v-if="form.newExpiresAt" class="mt-2 text-sm text-gray-500 dark:text-gray-400">
        ...
        <div class="flex items-center gap-2 border-t border-gray-200 pt-3 dark:border-gray-700">
          ...
          >
            ...
            <i v-else class="i-lucide-clock mr-2" />
            {{ loading ? '续期中...' : '确认续期' }}
          </button>
        </div>
      </div>
