<template>
  <div class="space-y-1">
    <div class="flex items-center justify-between text-sm">
      ...
      <span v-if="windowState === 'active'" class="font-medium text-gray-700 dark:text-gray-200">
        <i class="i-lucide-clock mr-1 text-blue-500" />
    ...
    <div v-if="showProgress" class="space-y-0.5">
      <div v-if="hasRequestLimit" class="space-y-0.5">
        <div class="flex items-center justify-between text-sm">
          <span class="text-gray-400 dark:text-gray-500">请求</span>
          <span class="text-gray-600 dark:text-gray-300"> {{ currentRequests || 0 }}/{{ requestLimit }} </span>
        </div>
      ...
      <div v-if="hasCostLimit" class="space-y-0.5">
        <div class="flex items-center justify-between text-sm">
          <span class="text-gray-400 dark:text-gray-500">费用</span>
          <span class="text-gray-600 dark:text-gray-300">
    ...
    <!-- 额外提示信息 -->
    <div v-if="windowState === 'active' && showTooltip" class="text-sm text-gray-500 dark:text-gray-400">
