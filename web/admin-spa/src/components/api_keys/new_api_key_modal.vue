<template>
  <ModalTransition @after-leave="onClosed">
    <div v-if="visible" class="modal fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        class="modal-content custom-scrollbar mx-auto max-h-[90vh] w-full max-w-lg overflow-y-auto p-4"
      >
        <div class="mb-3 flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            >
              <i class="i-lucide-check text-lg text-white" />
            </div>
            <div>
        ...
        <!-- 警告提示 -->
        <div
          class="mb-3 border-l-4 border-amber-400 bg-amber-50 p-3 dark:border-amber-500 dark:bg-amber-900/20"
        >
          ...
          <div>
            ...
            <div class="relative">
              ...
              <div class="absolute right-3 top-3">
                ...
                >
                  <i :class="['h-4 w-4 shrink-0 text-gray-300', showFullKey ? 'i-lucide-eye-off' : 'i-lucide-eye']" />
                </button>
              </div>
            </div>
