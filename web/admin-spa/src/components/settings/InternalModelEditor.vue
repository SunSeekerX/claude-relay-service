  ...
  <ModalTransition>
    ...
    >
      ...
      >
            ...
            <div class="grid gap-3 sm:grid-cols-2">
              <label class="block text-sm">
                ...
                <input
                  v-model="form.name"
                  :disabled="!isCreate"
                  class="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
          ...
          <section class="space-y-2 rounded-xl border border-gray-200 p-3 dark:border-gray-700">
            ...
            >
              ...
              <input
                ...
                class="w-full rounded-lg border border-gray-200 px-2 py-1.5 text-sm dark:border-gray-600 dark:bg-gray-900"
                type="number"
              />
            ...
            <div>
              ...
              >
                <input
                  ...
                  class="rounded-lg border border-gray-200 px-2 py-1.5 text-sm dark:border-gray-600 dark:bg-gray-900"
        ...
        >
          <button
            class="rounded-lg border border-gray-200 px-4 py-2 text-sm text-gray-600 dark:border-gray-600 dark:text-gray-300"
            @click="$emit('close')"
          >
            取消
          </button>
          <button
            ...
            @click="handleSave"
          >
            <i :class="['fas mr-1', saving ? 'fa-spinner fa-spin' : 'fa-save']" />
            保存
          </button>
        </div>
      </div>
...
import { createInternalModelApi, saveInternalModelApi } from '@/utils/http_apis.js'
