<template>
  <div class="api-input-wide-card mb-3 rounded-2xl p-3 shadow-xl sm:mb-4 sm:p-4">
    <!-- 标题区域 -->
    <div class="wide-card-title mb-3">
      <h2 class="mb-1 text-lg font-bold text-gray-900 dark:text-gray-200 sm:text-xl">
        <i class="i-lucide-chart-line mr-2" />
        使用统计查询
      </h2>
    ...
    <div class="mx-auto max-w-4xl">
      <!-- 控制栏 -->
      <div class="control-bar mb-2 flex flex-wrap items-center justify-between gap-2">
        <!-- API Key 标签 -->
        <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
          <i class="i-lucide-key mr-2" />
      ...
      <div class="api-input-grid grid grid-cols-1 gap-2 lg:grid-cols-4 lg:gap-3">
        <!-- API Key 输入 -->
        <div class="lg:col-span-3">
          ...
          <div v-if="!multiKeyMode" class="relative">
            <input
              v-model="apiKey"
              class="wide-card-input form-input--with-icon w-full"
              :disabled="loading"
        ...
        <div class="lg:col-span-1">
          <button
            ...
            @click="queryStats"
          >
            <i v-if="loading" class="i-lucide-loader-circle loading-spinner" />
      ...
      >
        <i class="i-lucide-lightbulb mr-2" />
...
.wide-card-title .i-lucide-chart-line {
  color: #3b82f6;
...
.security-notice .i-lucide-shield {
  color: #10b981;
