<template>
  ...
  <div v-if="!apiKey" class="py-12 text-center">
    <i class="i-lucide-wallet mb-3 text-4xl text-gray-300 dark:text-gray-600" />
  ...
  <div v-else class="space-y-5">
    ...
    >
      <i class="i-lucide-lock mb-2 text-3xl text-yellow-500" />
    ...
    <template v-else-if="!configLoading && config.enabled">
      ...
      >
        <i class="i-lucide-circle-check mb-3 text-5xl text-green-500" />
      ...
      <div v-else class="space-y-5">
        ...
        >
          <i v-if="ordering" class="i-lucide-loader-circle animate-spin mr-2" />立即充值
        </button>
      </div>
    </template>
    ...
    <div class="rounded-xl border border-gray-200 dark:border-gray-700">
      <button
        ...
        @click="toggleOrders"
      >
        <span><i class="i-lucide-scroll-text mr-2" />我的充值记录</span>
        <i :class="[showOrders ? 'i-lucide-chevron-up' : 'i-lucide-chevron-down', 'text-gray-400']" />
      </button>
