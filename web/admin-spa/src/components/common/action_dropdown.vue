<template>
  <div class="relative">
    ...
    >
      <i class="i-lucide-ellipsis-vertical text-sm"></i>
    </button>
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          ...
          >
            <i :class="[action.icon, 'w-4 text-center text-sm']"></i>
...
defineProps({
  actions: {
    type: Array,
    required: true
    // 格式: [{ key: 'edit', label: '编辑', icon: 'i-lucide-pen-line', color: 'blue', handler: () => {} }]
  }
})
