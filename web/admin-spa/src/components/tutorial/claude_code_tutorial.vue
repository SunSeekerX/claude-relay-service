  ...
  <div class="tutorial-content">
    ...
    <div class="mb-4 sm:mb-10 sm:mb-6">
      ...
      >
        ...
        >
          <i class="i-lucide-download mr-2 text-green-600" />
          安装 Claude Code
        </h5>
        ...
        <div
          class="mb-4 overflow-x-auto rounded-lg bg-gray-900 p-3 font-code text-sm text-green-400 sm:p-4 sm:text-sm"
        >
      ...
      >
        ...
        <div
          class="overflow-x-auto rounded bg-gray-900 p-2 font-code text-sm text-green-400 sm:p-3 sm:text-sm"
        >
    ...
    <div class="mb-6 sm:mb-10">
      ...
      >
        <h5
          class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
        >
          <i class="i-lucide-settings mr-2 text-purple-600" />
          配置 Claude Code 环境变量
        </h5>
        <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
        ...
        <div class="space-y-4">
          ...
          <template v-if="platform === 'windows'">
            ...
            >
              ...
              <div
                class="mb-3 overflow-x-auto rounded bg-gray-900 p-2 font-code text-sm text-green-400 sm:p-3 sm:text-sm"
              >
      ...
      >
        ...
        <div class="space-y-4">
          <div>
            ...
            <div
              class="space-y-1 overflow-x-auto rounded bg-gray-900 p-2 font-code text-sm text-green-400 sm:p-3 sm:text-sm"
            >
              <template v-if="platform === 'windows'">
    ...
    <div class="mb-8">
      <h4
        class="mb-3 flex items-center text-lg font-semibold text-gray-800 dark:text-gray-300 sm:mb-4 sm:text-xl"
      >
        <i class="i-lucide-wrench mr-2 text-red-600 sm:mr-3" />
        {{ platformName }} 常见问题解决
      </h4>
      <div class="space-y-4">
        <details
...
import { useTutorialUrls } from '@/libs/use_tutorial_urls'
import NodeInstallTutorial from './node_install_tutorial.vue'
