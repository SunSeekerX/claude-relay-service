  ...
  <div class="mb-4 sm:mb-10 sm:mb-6">
    ...
    <div v-if="platform === 'windows'" class="node-install-section">
      ...
      >
        ...
        >
          <i class="i-logos-microsoft-windows mr-2 text-blue-600" />
          Windows 安装方法
        </h5>
        ...
        <div class="mb-3 sm:mb-4">
          ...
          <div
            class="overflow-x-auto rounded-lg bg-gray-900 p-3 font-code text-sm text-green-400 dark:border dark:border-gray-700 dark:bg-gray-900 sm:p-4 sm:text-sm"
          >
    ...
    <div v-else-if="platform === 'macos'" class="node-install-section">
      ...
      >
        <h5
          class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
        >
          <i class="i-logos-apple mr-2 text-gray-700 dark:text-gray-400" />
          macOS 安装方法
        </h5>
        <div class="mb-4">
    ...
    <div v-else class="node-install-section">
      ...
      >
        <h5
          class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
        >
          <i class="i-logos-linux-tux mr-2 text-orange-600" />
          Linux / WSL2 安装方法
        </h5>
        <div class="mb-4">
