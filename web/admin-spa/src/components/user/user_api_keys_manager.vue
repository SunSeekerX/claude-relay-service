  ...
  <div class="space-y-6">
    <div class="sm:flex sm:items-center">
      ...
      <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
        <button
          class="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto dark:focus:ring-offset-gray-800"
              ...
              <div class="ml-4">
                <div class="flex items-center">
                  ...
                  <span
                    ...
                    class="ml-2 inline-flex items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-sm font-medium text-gray-800 dark:bg-gray-700 dark:text-gray-300"
                  >
                    Deleted
                  </span>
                  <span
                    v-else-if="!apiKey.isActive"
                    class="ml-2 inline-flex items-center rounded-full bg-red-100 px-2.5 py-0.5 text-sm font-medium text-red-800 dark:bg-red-900/30 dark:text-red-300"
                  >
                    Deleted
                  </span>
                </div>
            ...
            <div class="flex items-center space-x-2">
              ...
              <div class="flex items-center space-x-1">
                ...
                <button
                  ...
                  "
                  class="inline-flex items-center rounded border border-transparent p-1 text-red-400 hover:text-red-600 dark:text-red-400 dark:hover:text-red-300"
    ...
    <div v-else class="py-12 text-center">
      ...
      <div class="mt-6">
        <button
          class="inline-flex items-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
          @click="showCreateModal = true"
        >
          <svg class="-ml-1 mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
