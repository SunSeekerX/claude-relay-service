<template>
  <ModalTransition>
    <div v-if="show" class="modal fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4">
      <div
        class="modal-content custom-scrollbar mx-auto max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white/90 p-4 shadow-xl backdrop-blur-xl dark:bg-gray-800/95 dark:shadow-2xl sm:p-3 sm:p-4 md:p-4"
      >
        <div class="mb-3 flex items-center justify-between">
          <div class="flex items-center gap-2 sm:gap-3">
            ...
            >
              <i class="i-lucide-git-branch text-sm text-white sm:text-base" />
            </div>
        ...
        <div class="space-y-3">
          ...
          <div>
            ...
            <textarea
              ...
              class="form-input w-full resize-none border-transparent dark:border-transparent dark:bg-gray-700 dark:text-gray-200"
              placeholder="账户用途说明..."
              rows="3"
            />
          </div>
          ...
          <div>
            ...
            >
              <i class="i-lucide-plus mr-2" /> 添加模型映射
            </button>
          </div>
