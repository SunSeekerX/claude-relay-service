<template>
  <div class="min-w-[200px] space-y-1">
    <div v-if="loading" class="flex items-center gap-2">
      <i class="i-lucide-loader-circle animate-spin text-gray-400 dark:text-gray-500"></i>
    ...
    <div v-else-if="balanceData" class="space-y-1">
      ...
      <div class="flex items-center justify-between gap-2">
        <div class="flex items-center gap-2">
          <i
            ...
            :class="
              balanceData.balance
                ? 'i-lucide-wallet text-green-600 dark:text-green-400'
                : 'i-lucide-chart-line text-gray-500 dark:text-gray-400'
            "
          ></i>
        ...
        <button
          ...
          @click="refresh"
        >
          <i class="i-lucide-refresh-cw" :class="{ 'animate-spin': refreshing }"></i>
        </button>
      </div>
      ...
      <div v-else-if="balanceData.quota?.unlimited" class="flex items-center gap-2">
        <i class="i-lucide-infinity text-blue-500 dark:text-blue-400"></i>
