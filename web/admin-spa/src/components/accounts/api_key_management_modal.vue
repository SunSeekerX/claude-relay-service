<template>
  <ModalTransition>
    <div v-if="show" class="modal fixed inset-0 z-[60] flex items-center justify-center p-3 sm:p-4">
      <div
        class="modal-content custom-scrollbar mx-auto max-h-[90vh] w-full max-w-4xl overflow-y-auto p-3 sm:p-4"
      >
        <div class="mb-3 flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            ...
            >
              <i
                :class="[
                  ...
                  copyingAll ? 'i-lucide-loader-circle animate-spin' : 'i-lucide-clipboard-list'
                ]"
              />
              <span>复制全部 Key</span>
            </button>
            <button
              ...
              @click="$emit('close')"
            >
              <i class="i-lucide-x text-base sm:text-lg" />
            </button>
          </div>
        </div>
        ...
        >
          <i class="i-lucide-key mb-4 text-4xl text-gray-300 dark:text-gray-600" />
          ...
          <div class="mb-4 space-y-3">
            ...
            >
              ...
              <div class="mb-3 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <!-- 左侧：状态筛选 -->
                <div class="flex items-center gap-2">
                  <i class="i-lucide-filter text-gray-400 dark:text-gray-500" />
              ...
              <div class="flex flex-wrap items-center justify-between gap-2">
                ...
                <div class="flex flex-wrap items-center gap-2">
                  ...
                  >
                    <i class="i-lucide-file-output mr-1" />
                    导出全部
                  </button>
                </div>
                ...
                >
                  <i class="i-lucide-info text-purple-500 dark:text-purple-400" />
                ...
                <div class="flex items-start justify-between gap-2">
                  ...
                  <div class="flex items-center gap-1">
                    ...
                    >
                      ...
                      <i v-else class="i-lucide-redo-2"></i>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <i v-else class="i-lucide-trash-2" />
                    </button>
                  </div>
                </div>
          ...
          <div v-if="totalPages > 1" class="mt-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              <button
                ...
                @click="currentPage = 1"
              >
                <i class="i-lucide-chevrons-left" />
              </button>
              <button
                class="rounded-lg bg-gray-100 px-3 py-1.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                :disabled="currentPage === 1"
              ...
              >
                <i class="i-lucide-chevrons-right" />
              </button>
            </div>
          </div>
        </div>
