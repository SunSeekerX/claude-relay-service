    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <i class="i-lucide-info text-blue-400" />
            <span>账户错误与自动暂停机制说明</span>
            <i class="ml-auto" :class="showHelp ? 'i-lucide-chevron-up' : 'i-lucide-chevron-down'" />
          </button>
          <div
            v-if="showHelp"
        ...
        <div class="flex-1 overflow-y-auto px-5 py-4">
          ...
          <div v-if="loading" class="flex items-center justify-center py-12">
            <i class="i-lucide-loader-circle animate-spin mr-2 text-gray-400" />
          ...
          <div v-else class="space-y-3">
            ...
            >
              ...
              >
                ...
                <span v-if="item.context.reason">
                  <i class="i-lucide-tag mr-1" />{{ item.context.reason }}
                </span>
              </div>
              ...
              <div v-if="hasDetail(item.context)" class="mt-2">
                ...
                >
                  ...
                  <i
                    class="ml-1"
                    :class="expandedIdx === idx ? 'i-lucide-chevron-up' : 'i-lucide-chevron-down'"
                  />
                </button>
            ...
            <div v-if="hasMore" class="flex justify-center pb-1 pt-2">
              <button
                ...
                @click="loadMore"
              >
                <i v-if="loadingMore" class="i-lucide-loader-circle animate-spin mr-1" />
