<template>
  <div class="space-y-3">
    ...
    <div v-if="platform === 'claude'">
      ...
      >
        <div class="flex items-start gap-4">
          ...
          >
            <i class="i-lucide-link text-white" />
          </div>
          <div class="flex-1">
            ...
            <div class="mb-4">
              ...
              <CuteOptionCards
                v-model="authMethod"
                :columns="2"
                :options="claudeAuthMethodOptions"
                size="sm"
            ...
            <div v-if="authMethod === 'cookie'" class="space-y-4">
              ...
              >
                ...
                <div class="mb-4">
                  ...
                  >
                    <i class="i-lucide-cookie text-blue-500" />
                    sessionKey
                    <span
                    ...
                    >
                      <i class="i-lucide-circle-question-mark" />
                    </button>
                  </label>
                  <textarea
                    v-model="sessionKey"
                ...
                >
                  <h5 class="mb-2 font-semibold text-amber-800 dark:text-amber-200">
                    <i class="i-lucide-lightbulb mr-1" />如何获取 sessionKey
                  </h5>
                  <ol
                ...
                >
                  <p class="text-sm text-red-600 dark:text-red-400">
                    <i class="i-lucide-circle-alert mr-1" />
                    {{ cookieAuthError }}
                  </p>
                </div>
                ...
                >
                  <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1">
                      ...
                      >
                        <i v-if="!loading" class="i-lucide-link mr-2" />
                      ...
                      <div v-else class="space-y-3">
                        <div class="flex items-center gap-2">
                          ...
                          <button
                            ...
                            @click="copyAuthUrl"
                          >
                            <i :class="copied ? 'i-lucide-check text-green-500' : 'i-lucide-copy'" />
                          </button>
                        </div>
                        <button
    ...
    <div v-else-if="platform === 'gemini' || platform === 'gemini-antigravity'">
      <div
        class="rounded-lg border border-green-200 bg-green-50 p-3 dark:border-green-700 dark:bg-green-900/30 sm:p-4"
      >
        <div class="flex items-start gap-4">
          <div
            class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-green-500"
          >
            <i class="i-lucide-bot text-white" />
          </div>
          <div class="flex-1">
                    ...
                    <div class="space-y-3">
                      <div>
                        <label
                          class="mb-2 block text-sm font-semibold text-gray-700 dark:text-gray-300"
                        >
                          <i class="i-lucide-key mr-2 text-green-500" />Authorization Code
                        </label>
                        <textarea
                          v-model="authCode"
                          class="form-input w-full resize-none font-mono text-sm"
                      ...
                      <div class="mt-2 space-y-1">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                          <i class="i-lucide-circle-check mr-1 text-green-500" />
    ...
    <div v-else-if="platform === 'openai'">
      <div
        class="rounded-lg border border-orange-200 bg-orange-50 p-3 dark:border-orange-700 dark:bg-orange-900/30 sm:p-4"
      >
        <div class="flex items-start gap-4">
          <div
            class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-orange-500"
          >
            <i class="i-lucide-brain text-white" />
          </div>
          <div class="flex-1">
                    ...
                    <div class="space-y-3">
                      <div>
                        <label
                          class="mb-2 block text-sm font-semibold text-gray-700 dark:text-gray-300"
                        >
                          <i class="i-lucide-link mr-2 text-orange-500" />授权链接或 Code
                        </label>
                        <textarea
                          v-model="authCode"
                          class="form-input w-full resize-none font-mono text-sm"
                      ...
                      >
                        <p class="text-sm text-blue-700 dark:text-blue-300">
                          <i class="i-lucide-lightbulb mr-1" />
    ...
    <div v-else-if="platform === 'droid'">
      <div
        class="rounded-lg border border-cyan-200 bg-cyan-50 p-3 dark:border-cyan-700 dark:bg-cyan-900/30 sm:p-4"
      >
        <div class="flex items-start gap-4">
          <div
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div class="flex-1">
                    ...
                    <div v-else class="space-y-4">
                      <div class="space-y-2">
                        ...
                        >
                          ...
                          <div class="flex flex-wrap items-center gap-2">
                            ...
                            >
                              <i class="i-lucide-external-link text-sm" /> 在新标签中打开
                            </button>
                            <button
                              ...
                              @click="regenerateAuthUrl"
                            >
                              <i class="i-lucide-refresh-cw text-sm" />重新生成
                            </button>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <span>
                          <i class="i-lucide-hourglass mr-1 text-cyan-500" />
    ...
    <div v-else-if="platform === 'grok'">
      <div
        class="rounded-lg border border-violet-200 bg-violet-50 p-3 dark:border-violet-700 dark:bg-violet-900/30 sm:p-4"
      >
        <div class="flex items-start gap-4">
          <div
            class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-violet-500"
          >
            <i class="i-lucide-zap text-white" />
          </div>
          <div class="flex-1">
...
const claudeAuthMethodOptions = [
  {
    value: 'manual',
    label: '手动授权',
    description: '复制链接在浏览器完成授权',
    icon: 'i-lucide-link'
  },
  {
    value: 'cookie',
...
const grokAuthMethodOptions = [
  {
    value: 'manual',
    label: '浏览器 OAuth',
    description: '标准设备授权流程',
    icon: 'i-lucide-globe'
  },
  {
    value: 'sso',
    label: 'SSO Cookie 导入',
    description: '粘贴 sso Cookie 批量导入',
    icon: 'i-lucide-cookie'
  }
]
