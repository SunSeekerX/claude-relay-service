      ...
      >
        ...
        <div class="min-h-0 flex-1 overflow-y-auto px-5 py-4">
          ...
          <template v-else>
                ...
                >
                  <div class="flex items-center gap-2">
                    <i
                      :class="[
                        record.success
                          ? 'i-lucide-circle-check text-green-500'
                          : 'i-lucide-circle-x text-red-500'
                      ]"
                    />
            ...
            >
              <i class="i-lucide-scroll-text mb-2 text-2xl text-gray-300 dark:text-gray-600" />
              <p>暂无测试记录</p>
            </div>
          </template>
        </div>
        ...
        >
          ...
          <button
            ...
            @click="saveConfig"
          >
            <i :class="[saving ? 'i-lucide-loader-circle animate-spin' : 'i-lucide-save']" />
            {{ saving ? '保存中...' : '保存配置' }}
          </button>
        </div>
      </div>
