      ...
      >
        ...
        >
          <div class="flex flex-1 items-start gap-3">
            ...
            >
              <i class="i-lucide-chart-area text-lg" />
            </div>
            <div class="space-y-1">
              <div class="flex flex-wrap items-center gap-2">
                ...
                >
                  <i class="i-lucide-layers mr-1" />{{ platformLabel }}
                </span>
                <span
                ...
                >
                  <i class="i-lucide-user-round-cog mr-1" />{{ accountTypeLabel }}
                </span>
              </div>
          ...
          <template v-else>
            ...
            <div class="mb-3 grid grid-cols-1 gap-3 lg:grid-cols-3">
              ...
              >
                ...
                >
                  <i class="i-lucide-database mr-2 text-indigo-500" /> 累计 Token
                </h4>
              ...
              >
                <h4
                  class="mb-3 flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300"
                >
                  <i class="i-lucide-gauge mr-2 text-purple-500" /> 平均速率
                </h4>
                <div class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                  <div class="flex items-center justify-between">
                    <span>RPM</span>
              ...
              >
                <h4
                  class="mb-3 flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300"
                >
                  <i class="i-lucide-layers mr-2 text-teal-500" /> 最近统计
                </h4>
                <div class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                  <div class="flex items-center justify-between">
                    <span>今日请求</span>
            ...
            <!-- 折线图 -->
            <div
              class="mb-3 rounded-2xl border border-gray-200 bg-white/80 p-3 shadow-sm dark:border-gray-700 dark:bg-gray-900/70"
            >
              <div class="mb-4 flex flex-wrap items-center justify-between gap-2">
                <h4
                  class="flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300"
                >
                  <i class="i-lucide-chart-line mr-2 text-blue-500" /> 30天费用与请求趋势
                </h4>
