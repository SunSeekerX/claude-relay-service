<template>
  <ModalTransition>
    ...
    >
      <div
        class="modal-panel relative top-20 mx-auto w-96 rounded-md border border-gray-200 bg-white p-5 shadow-lg dark:border-gray-700 dark:bg-gray-800"
      >
        <div class="mt-3">
          <div class="mb-4 flex items-center justify-between">
            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Change User Role</h3>
            <button
          ...
          <div v-if="user" class="space-y-4">
            <!-- User Info -->
            <div class="rounded-md bg-gray-50 p-4 dark:bg-gray-800/60">
              ...
              >
                <div class="flex">
                  ...
                  <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-400 dark:text-yellow-300">
