    ...
    >
      <div class="stat-card">
        <div class="flex items-center justify-between">
          <div>
            <p class="mb-0.5 text-sm font-semibold text-gray-600 dark:text-gray-400">
              总API Keys
            </p>
          ...
          <div class="flex-1">
            ...
            <div class="flex flex-wrap items-baseline gap-x-2">
              ...
              <div v-if="dashboardData.accountsByPlatform" class="flex items-center gap-2">
                ...
                >
                  <i class="i-lucide-brain text-sm text-indigo-600" />
                ...
                >
                  <i class="i-lucide-terminal text-sm text-purple-600" />
                  <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
                ...
                >
                  <i class="i-lucide-bot text-sm text-yellow-600" />
                  <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
                ...
                >
                  <i class="i-logos-aws text-sm text-orange-600" />
                  <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
                ...
                >
                  <i class="icon-openai text-sm text-gray-100" />
                  <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
                ...
                >
                  <i class="i-logos-microsoft-icon text-sm text-blue-600" />
                  <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
                ...
                >
                  <i class="i-lucide-server text-sm text-cyan-600" />
                  <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
                ...
                >
                  <i class="i-lucide-zap text-sm text-violet-600" />
                  <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
      ...
      <div class="stat-card">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-xl font-bold text-green-600 sm:text-2xl">
    ...
    <div class="mb-3 grid grid-cols-1 gap-2 sm:mb-4 sm:grid-cols-2 sm:gap-3 md:mb-5 md:gap-4">
      <div class="stat-card">
        ...
        <div class="mt-3 flex items-center justify-between gap-3">
          ...
          >
            <i :class="[loadingBalanceSummary ? 'i-lucide-loader-circle animate-spin' : 'i-lucide-refresh-cw']" />
            刷新
          </button>
        </div>
      </div>
      ...
      <div class="stat-card">
        <div class="flex items-center justify-between">
          <div class="mr-8 flex-1">
            ...
            <div class="mb-2 flex flex-wrap items-baseline gap-2">
              <p class="text-xl font-bold text-emerald-600 sm:text-2xl">
                {{
                  formatNumber(
      ...
      <div class="stat-card">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-xl font-bold text-rose-600 sm:text-2xl">
    ...
    <div class="mb-5">
      <div class="mb-3 flex flex-col gap-3 sm:mb-4">
        ...
        <div class="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-end">
          ...
          <SegmentedTabs
            size="sm"
            :model-value="dateFilter.type === 'preset' ? dateFilter.preset : ''"
            :tabs="dateFilter.presetOptions"
            @update:model-value="setDateFilterPreset"
          />
          ...
          <SegmentedTabs
            ...
            :tabs="[
              { key: 'day', label: '按天', icon: 'i-lucide-calendar-days' },
              { key: 'hour', label: '按小时', icon: 'i-lucide-clock' }
            ]"
            @update:model-value="setTrendGranularity"
          />
          ...
          <div class="flex items-center gap-2">
            ...
            <div class="flex items-center rounded-lg bg-gray-100 px-3 py-1 dark:bg-gray-700">
              <label class="relative inline-flex cursor-pointer items-center">
                ...
                >
                  <i class="i-lucide-redo-2 text-sm text-gray-500 dark:text-gray-400" />
                  <span>自动刷新</span>
                  <span
            ...
            >
              <i :class="['i-lucide-refresh-cw text-sm', { 'animate-spin': isRefreshing }]" />
    ...
    <div class="mb-3 sm:mb-4 md:mb-5">
      <div class="card p-3 sm:p-4">
        <div class="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <SegmentedTabs
            size="sm"
            :model-value="apiKeysTrendMetric"
            :tabs="[
              { key: 'requests', label: '请求次数', icon: 'i-lucide-arrow-left-right' },
              { key: 'tokens', label: 'Token 数量', icon: 'i-lucide-coins' }
            ]"
            @update:model-value="onApiKeysTrendMetricChange"
          />
        </div>
      ...
      <div class="card p-3 sm:p-4">
        <div class="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div class="flex flex-wrap items-center gap-2">
            <SegmentedTabs
              size="sm"
              :model-value="accountUsageGroup"
              :tabs="accountGroupOptions"
              @update:model-value="handleAccountUsageGroupChange"
            />
          </div>
        </div>
        <div
...
const onApiKeysTrendMetricChange = async (metric) => {
  if (!metric || metric === apiKeysTrendMetric.value) return
  apiKeysTrendMetric.value = metric
  await updateApiKeysUsageTrendChart()
}
