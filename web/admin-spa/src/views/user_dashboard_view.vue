<template>
  <div class="h-full min-h-0 overflow-y-auto bg-gray-50 dark:bg-gray-900">
    <!-- 导航栏 -->
    ...
    <main class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div v-if="activeTab === 'overview'" class="space-y-3">
        ...
        <!-- Stats Cards -->
        <div class="grid grid-cols-1 gap-2 sm:gap-3 md:grid-cols-2 lg:grid-cols-5">
      ...
      <!-- Tutorial Tab -->
      <div v-else-if="activeTab === 'tutorial'" class="space-y-3">
        <TutorialView />
      </div>
    </main>
  </div>
...
import UserApiKeysManager from '@/components/user/user_api_keys_manager.vue'
import UserUsageStats from '@/components/user/user_usage_stats.vue'
import TutorialView from '@/views/tutorial_view.vue'
