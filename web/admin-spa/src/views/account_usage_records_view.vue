  ...
  <div class="space-y-3 p-3 sm:p-4">
    <div class="flex flex-wrap items-center justify-between gap-2">
      <div class="flex items-center gap-2">
        <button
          class="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 text-sm text-gray-700 transition hover:bg-gray-100 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800"
          @click="goBack"
        >
          ← 返回
        </button>
        <div>
          ...
          <h2 class="text-lg font-bold text-gray-900 dark:text-gray-100 sm:text-xl">
            {{ accountDisplayName }}
          </h2>
    ...
    >
      <div class="flex flex-wrap items-center gap-3">
        ...
        <button class="rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200" type="button" @click="resetFilters"><i class="i-lucide-undo-2 mr-2" />重置</button>
        <button class="rounded-lg bg-blue-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50" :disabled="exporting" type="button" @click="exportCsv"><i :class="['mr-2', exporting ? 'i-lucide-loader-circle animate-spin' : 'i-lucide-file-output']" />导出 CSV</button>
      </div>
    </div>
