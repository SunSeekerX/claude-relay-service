  ...
  <div class="accounts-container">
    ...
    <div v-show="activeView === 'accounts'" class="relative">
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div class="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
            ...
            <div class="min-w-[160px]">
              <CustomDropdown
                ...
                accent="indigo"
                :icon="accountsSortOrder === 'asc' ? 'i-lucide-arrow-up-wide-narrow' : 'i-lucide-arrow-down-wide-narrow'"
                :options="sortOptions"
                placeholder="选择排序"
          ...
          <div class="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
            ...
            <div class="relative">
              <AppTooltip content="查看账户统计汇总" placement="bottom">
                ...
                >
                  ...
                  ></div>
                  <i class="i-lucide-chart-column relative text-violet-500" />
                ...
                >
                  ...
                  <i
                    :class="[
                      ...
                      refreshingBalances ? 'i-lucide-loader-circle animate-spin' : 'i-lucide-wallet'
                    ]"
                  />
            ...
            >
              ...
              ></div>
              <i class="i-lucide-trash-2 relative text-red-600 dark:text-red-400" />
            ...
            >
              <i class="i-lucide-arrow-left-right text-indigo-500"></i>
              <span>导入/导出</span>
            </button>
      ...
      <div v-else-if="sortedAccounts.length === 0" class="py-12 text-center">
        ...
        >
          <i class="i-lucide-circle-user text-xl text-gray-400" />
        </div>
      ...
      <div v-else class="table-wrapper hidden md:block">
        ...
        >
          <table class="w-full">
            ...
            >
              <tr>
                <th class="checkbox-column sticky left-0 z-20 min-w-[50px] px-3 py-3 text-left">
                ...
                <th
                  class="name-column sticky left-[50px] z-20 min-w-[180px] cursor-pointer px-3 py-3 text-left text-sm font-bold uppercase tracking-wider text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600"
                ...
                >
                  ...
                  <i
                    ...
                    :class="[
                      accountsSortOrder === 'asc' ? 'i-lucide-arrow-up' : 'i-lucide-arrow-down',
                      'ml-1'
                    ]"
                  />
                ...
                <th
                  class="min-w-[220px] cursor-pointer px-3 py-3 text-left text-sm font-bold uppercase tracking-wider text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600"
                ...
                <th
                  class="w-[120px] min-w-[180px] max-w-[200px] cursor-pointer px-3 py-3 text-left text-sm font-bold uppercase tracking-wider text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600"
                ...
                <th
                  class="min-w-[150px] px-3 py-3 text-left text-sm font-bold uppercase tracking-wider text-gray-700 dark:text-gray-300"
                >
                  今日使用
                </th>
                <th
                  class="min-w-[220px] px-3 py-3 text-left text-sm font-bold uppercase tracking-wider text-gray-700 dark:text-gray-300"
                >
                  余额/配额
                </th>
                <th
                  class="min-w-[210px] px-3 py-3 text-left text-sm font-bold uppercase tracking-wider text-gray-700 dark:text-gray-300"
                >
                  <div class="flex items-center gap-2">
                    ...
                    <AppTooltip placement="top">
                      <template #content>
                        ...
                        >
                          ...
                          <div class="space-y-2">
                            ...
                            <div class="space-y-1 text-gray-200 dark:text-gray-600">
                              <div class="flex items-start gap-2">
                                <i class="i-lucide-clock mt-[2px] text-sm text-blue-500"></i>
                                <span class="font-medium text-white dark:text-gray-900"
                                  >5h 窗口：5小时使用量进度，到达重置时间后会自动归零。</span
                                >
                              </div>
                              <div class="flex items-start gap-2">
                                <i class="i-lucide-scroll-text mt-[2px] text-sm text-emerald-500"></i>
                                <span class="font-medium text-white dark:text-gray-900"
                                  >周限窗口：7天使用量进度，重置时同样回到 0%。</span
                                >
                              </div>
                              <div class="flex items-start gap-2">
                                <i class="i-lucide-info mt-[2px] text-sm text-indigo-500"></i>
                                <span class="font-medium text-white dark:text-gray-900"
                          ...
                          <div class="space-y-2">
                            ...
                            <div class="space-y-1 text-gray-200 dark:text-gray-600">
                              <div class="flex items-start gap-2">
                                <i class="i-lucide-clock mt-[2px] text-sm text-indigo-500"></i>
                                <span class="font-medium text-white dark:text-gray-900"
                              ...
                              <div class="flex items-start gap-2">
                                <i
                                  class="i-lucide-calendar-days mt-[2px] text-sm text-emerald-500"
                                ></i>
                                <span class="font-medium text-white dark:text-gray-900"
                              ...
                              <div class="flex items-start gap-2">
                                <i class="i-lucide-gem mt-[2px] text-sm text-purple-500"></i>
                                <span class="font-medium text-white dark:text-gray-900"
                                  >Sonnet窗口：7天Sonnet模型专用限额。</span
                                >
                              </div>
                              <div class="flex items-start gap-2">
                                <i class="i-lucide-refresh-cw mt-[2px] text-sm text-blue-500"></i>
                                <span class="font-medium text-white dark:text-gray-900"
                                  >到达重置时间后自动归零。</span
                                >
                              </div>
                      ...
                      <i
                        class="i-lucide-circle-question-mark cursor-help text-sm text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-400"
                      />
                    </AppTooltip>
                  </div>
                </th>
                <th
                  class="min-w-[80px] px-3 py-3 text-left text-sm font-bold uppercase tracking-wider text-gray-700 dark:text-gray-300"
                >
                  最后使用
                </th>
                <th
                  class="min-w-[80px] cursor-pointer px-3 py-3 text-left text-sm font-bold uppercase tracking-wider text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600"
                ...
                <th
                  class="min-w-[110px] cursor-pointer px-3 py-3 text-left text-sm font-bold uppercase tracking-wider text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600"
                ...
                <th
                  class="operations-column sticky right-0 z-20 min-w-[230px] px-3 py-3 text-left text-sm font-bold uppercase tracking-wider text-gray-700 dark:text-gray-300"
                >
                  操作
                </th>
              </tr>
              ...
              <tr v-for="account in paginatedAccounts" :key="account.id" class="table-row">
                  ...
                  <div class="flex items-center">
                    ...
                    <div class="min-w-0">
                      ...
                      >
                        ...
                        >
                          <i class="i-lucide-folder mr-1" />{{ group.name }}
                        </span>
                      </div>
                      <div
                ...
                <td class="px-3 py-3">
                  <div class="flex items-center gap-1">
                    ...
                    >
                      <i class="i-lucide-terminal text-sm text-purple-700" />
                    ...
                    >
                      <i class="i-logos-aws text-sm text-orange-700" />
                    ...
                    >
                      <i class="i-logos-microsoft-icon text-sm text-blue-700 dark:text-blue-400" />
                    ...
                    >
                      <i class="i-lucide-server text-sm text-teal-700 dark:text-teal-400" />
                    ...
                    >
                      <i class="i-lucide-brain text-sm text-indigo-700" />
                    ...
                    >
                      <i class="i-lucide-git-branch text-sm text-teal-700 dark:text-teal-400" />
                      <span class="text-sm font-semibold text-teal-800 dark:text-teal-300"
                        >CCR</span
                      >
                      <span class="mx-1 h-4 w-px bg-teal-300 dark:bg-teal-600" />
                    ...
                    >
                      <i class="i-lucide-bot text-sm text-cyan-700 dark:text-cyan-400" />
                    ...
                    >
                      <i class="i-lucide-bot text-sm text-amber-700 dark:text-amber-400" />
                    ...
                    >
                      <i class="i-lucide-circle-question-mark text-sm text-gray-700" />
                      <span class="text-sm font-semibold text-gray-800">未知</span>
                    </div>
                  </div>
                </td>
                <td class="w-[100px] min-w-[100px] max-w-[100px] whitespace-nowrap px-3 py-3">
                  <div class="flex flex-col gap-1">
                    ...
                    >
                      ...
                      <AppTooltip
                        ...
                        placement="top"
                      >
                        <i class="i-lucide-info ml-1 cursor-help" />
                      </AppTooltip>
                    </span>
                    <span
                    ...
                    >
                      <i class="i-lucide-circle-pause mr-1" />
                      不可调度
                      <AppTooltip
                        ...
                        placement="top"
                      >
                        <i class="i-lucide-circle-question-mark ml-1 cursor-help text-gray-500" />
                      </AppTooltip>
                    </span>
                    <span
                      v-if="
                ...
                <td class="whitespace-nowrap px-3 py-3">
                  ...
                  <div v-else-if="account.platform === 'claude-console'" class="space-y-3">
                    ...
                    <div class="space-y-1">
                      ...
                      >
                        <i class="i-lucide-infinity mr-1" />并发无限制
                      </div>
                    </div>
                  </div>
                ...
                <td class="whitespace-nowrap px-3 py-3">
                  <div class="flex flex-col gap-1">
                    ...
                    <span v-if="account.expiresAt">
                      ...
                      >
                        <i class="i-lucide-circle-alert mr-1 text-sm" />
                        已过期
                      </span>
                      <span
                        ...
                        @click.stop="startEditAccountExpiry(account)"
                      >
                        <i class="i-lucide-clock mr-1 text-sm" />
                    ...
                    <span
                      ...
                      @click.stop="startEditAccountExpiry(account)"
                    >
                      <i class="i-lucide-infinity mr-1 text-sm" />
                      永不过期
                    </span>
                  </div>
                </td>
                <td
                  class="operations-column sticky right-0 z-10 whitespace-nowrap px-3 py-3 text-sm font-medium"
                >
                  <div class="flex max-w-[230px] flex-wrap items-center gap-1.5">
                    ...
                    >
                      <i :class="['i-lucide-redo-2', account.isResetting ? 'animate-spin' : '']" />
                    ...
                    >
                      <i :class="[account.schedulable ? 'i-lucide-toggle-right' : 'i-lucide-toggle-left']" />
                    ...
                    >
                      <i class="i-lucide-flask-conical" />
        ...
        >
              ...
              >
                <div class="flex items-center justify-between text-sm">
                  <div class="flex items-center gap-1">
                    ...
                    >
                      <i
                        class="i-lucide-circle-question-mark cursor-help text-sm text-gray-400 hover:text-gray-600"
                      />
                    </AppTooltip>
                  </div>
                  <span class="font-medium text-gray-700 dark:text-gray-200">
          ...
          >
            ...
            <button
              ...
              @click="toggleSchedulable(account)"
            >
              <i :class="[account.schedulable ? 'i-lucide-pause' : 'i-lucide-play']" />
            ...
            <button
              ...
              @click="editAccount(account)"
            >
              <i class="i-lucide-pen-line mr-1" />
              编辑
            </button>
    ...
    >
      <div class="modal-content max-h-[90vh] w-full max-w-[1200px] overflow-auto rounded-2xl bg-white p-3 sm:p-4 shadow-xl dark:bg-gray-900">
...
import AccountScheduledTestModal from '@/components/accounts/account_scheduled_test_modal.vue'
...
import GroupManagementModal from '@/components/accounts/group_management_modal.vue'
import BalanceDisplay from '@/components/accounts/balance_display.vue'
import AccountBalanceScriptModal from '@/components/accounts/account_balance_script_modal.vue'
import AccountMigrationModal from '@/components/accounts/account_migration_modal.vue'
...
const sortOptions = ref([
  { value: 'name', label: '按名称排序', icon: 'i-lucide-type' },
  { value: 'dailyTokens', label: '按今日Token排序', icon: 'i-lucide-coins' },
  { value: 'dailyRequests', label: '按今日请求数排序', icon: 'i-lucide-chart-line' },
  { value: 'totalTokens', label: '按总Token排序', icon: 'i-lucide-database' },
  { value: 'lastUsed', label: '按最后使用排序', icon: 'i-lucide-clock' },
  { value: 'rateLimitTime', label: '按限流时间排序', icon: 'i-lucide-hourglass' }
])
...
const platformHierarchy = [
  {
    ...
    icon: 'i-lucide-brain',
    children: [
      { value: 'claude', label: 'Claude 官方/OAuth', icon: 'i-lucide-brain' },
      { value: 'claude-console', label: 'Claude Console', icon: 'i-lucide-terminal' },
      { value: 'bedrock', label: 'Bedrock', icon: 'i-logos-aws' },
      { value: 'ccr', label: 'CCR Relay', icon: 'i-lucide-git-branch' }
    ]
  },
  {
    value: 'group-openai',
    ...
    icon: 'icon-openai',
    children: [
      { value: 'openai', label: 'OpenAI 官方', icon: 'icon-openai' },
      { value: 'openai-responses', label: 'OpenAI-Responses (Codex)', icon: 'i-lucide-server' },
      { value: 'azure_openai', label: 'Azure OpenAI', icon: 'i-logos-microsoft-icon' }
    ]
  },
  {
    value: 'group-gemini',
    ...
    children: [
      { value: 'gemini', label: 'Gemini OAuth', icon: 'i-logos-google-icon' },
      { value: 'gemini-api', label: 'Gemini API', icon: 'i-lucide-key' }
    ]
  },
  {
    value: 'group-droid',
    label: 'Droid（全部）',
    icon: 'i-lucide-bot',
    children: [{ value: 'droid', label: 'Droid', icon: 'i-lucide-bot' }]
  },
  {
    value: 'group-grok',
    label: 'Grok / xAI（全部）',
    icon: 'i-lucide-zap',
    children: [{ value: 'grok', label: 'Grok', icon: 'i-lucide-zap' }]
  }
]
...
const platformOptions = computed(() => {
  const options = [{ value: 'all', label: '所有平台', icon: 'i-lucide-globe', indent: 0 }]
...
const statusOptions = ref([
  { value: 'normal', label: '正常', icon: 'i-lucide-circle-check' },
  { value: 'unschedulable', label: '不可调度', icon: 'i-lucide-ban' },
  { value: 'rateLimited', label: '限流', icon: 'i-lucide-hourglass' },
  { value: 'other', label: '其他', icon: 'i-lucide-triangle-alert' },
  { value: 'all', label: '全部状态', icon: 'i-lucide-list' }
])
...
const groupTypeOptions = computed(() => {
  const options = [{ value: 'all', label: '所有类型', icon: 'i-lucide-globe' }]
  const seen = new Set()
  accountGroups.value.forEach((group) => {
    ...
    options.push({
      ...
      icon: GROUP_PLATFORM_ICONS[group.platform] || 'i-lucide-layers'
    })
  })
  return options
})
...
const groupOptions = computed(() => {
  const options = [{ value: 'all', label: '所有账户', icon: 'i-lucide-globe' }]
  // “未分组账户”不属于任何分组类型，仅在未限定分组类型时提供，避免与“分组类型”产生矛盾组合
  if (groupTypeFilter.value === 'all') {
    options.push({ value: 'ungrouped', label: '未分组账户', icon: 'i-lucide-user' })
  }
  accountGroups.value.forEach((group) => {
