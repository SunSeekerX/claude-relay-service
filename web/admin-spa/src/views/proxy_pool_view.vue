  ...
  <div class="tab-content">
    ...
    <div class="relative flex flex-col">
      ...
      <div class="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <div class="flex flex-wrap gap-2 sm:ml-auto">
          ...
          >
            <i class="i-lucide-settings mr-2" />设置
          </button>
          <button
            ...
            @click="refreshAll"
          >
            <i class="i-lucide-refresh-cw mr-1.5" :class="{ 'animate-spin': refreshing }" />刷新
          </button>
          <button
          ...
          >
            <i class="i-lucide-plus mr-2" />添加代理
          </button>
          <button
          ...
          >
            <i class="i-lucide-plus mr-2" />添加分组
          </button>
        </div>
      </div>
      ...
      <div v-show="activeTab === 'proxies'" class="flex min-h-0 flex-1 flex-col">
        ...
        <div class="space-y-3 md:hidden">
          <div
            ...
            class="card p-3 text-center text-sm text-gray-500 dark:text-gray-400 sm:p-4"
          >
            <i class="i-lucide-loader-circle animate-spin mr-2 text-blue-500" />加载中...
          </div>
          <div
        ...
        <div class="modal-content mx-auto max-h-[90vh] w-full max-w-lg overflow-y-auto p-3 sm:p-4">
          ...
          <div class="mt-6 flex gap-3">
            ...
            <button class="btn-primary" :disabled="saving" @click="saveProxy">
              <i v-if="saving" class="i-lucide-loader-circle animate-spin mr-2" />{{
                saving ? '提交中...' : '确定'
              }}
            </button>
          </div>
    ...
    <ModalTransition :teleport="false">
      <div v-if="groupModal" class="modal fixed inset-0 z-50 flex items-center justify-center p-4">
        <div class="modal-content mx-auto w-full max-w-md overflow-y-auto p-3 sm:p-4">
          <div class="mb-5 flex items-center justify-between">
            <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100">
        ...
        <div class="modal-content mx-auto max-h-[90vh] w-full max-w-lg overflow-y-auto p-3 sm:p-4">
          ...
          <div class="mb-4">
            ...
            <div class="space-y-3">
              <div class="flex items-center justify-between">
                ...
                <AppSwitch
                  v-model="settingsForm.healthCheckEnabled"
                  color="blue"
                  size="md"
                />
              </div>
          ...
          <div class="mt-6 flex gap-3">
            ...
            <button class="btn-primary" :disabled="settingsSaving" @click="saveSettings">
              <i v-if="settingsSaving" class="i-lucide-loader-circle animate-spin mr-2" />{{
...
.stat-card {
  @apply rounded-xl border border-gray-100 bg-white/60 p-2 backdrop-blur-sm dark:border-gray-700 dark:bg-gray-800/60;
}
