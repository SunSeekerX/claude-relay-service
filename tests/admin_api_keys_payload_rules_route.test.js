...
import * as requestBodyRuleService from '../src/modules/relay/relay_request_body_rule_service.js'
import '../src/modules/apikey/apikey_routes.js'
const mockRouter = {
  get: jest.fn(),
  post: jest.fn(),
  put: jest.fn(),
...
jest.mock('../src/modules/relay/relay_request_body_rule_service.js', () => ({
