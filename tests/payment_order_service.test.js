...
import { paymentConfig } from '../src/modules/payment/payment_config.js'
import { orderRepository } from '../src/modules/payment/payment_order_repository.js'
import { planRepository } from '../src/modules/payment/payment_plan_repository.js'
import { balanceLedger } from '../src/modules/payment/payment_balance_ledger.js'
import { registry } from '../src/modules/payment/payment_registry.js'
import { providerRepository } from '../src/modules/payment/payment_provider_repository.js'
import { paymentOrderService } from '../src/modules/payment/payment_order_service.js'
...
jest.mock('../src/modules/payment/payment_config.js', () => ({ getConfig: jest.fn() }))
jest.mock('../src/modules/payment/payment_order_repository.js', () => ({
  save: jest.fn(),
  getById: jest.fn(),
  setFields: jest.fn(),
  casStatus: jest.fn(),
...
jest.mock('../src/modules/payment/payment_plan_repository.js', () => ({ getById: jest.fn() }))
jest.mock('../src/modules/payment/payment_balance_ledger.js', () => ({
  get: jest.fn(),
  credit: jest.fn(),
  reverse: jest.fn(),
  setBaselineIfAbsent: jest.fn()
}))
jest.mock('../src/modules/payment/payment_registry.js', () => ({
  hasType: jest.fn(),
  getByType: jest.fn(),
  getByKey: jest.fn(),
  findByKey: jest.fn()
}))
jest.mock('../src/modules/payment/payment_provider_repository.js', () => ({
...
jest.mock('../src/modules/payment/payment_audit.js', () => ({
  record: jest.fn(),
  list: jest.fn()
}))
