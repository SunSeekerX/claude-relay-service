import * as parsers from '../src/modules/account/account_migration_parsers.js'
import * as mappers from '../src/modules/account/account_migration_mappers.js'
import { _internal } from '../src/modules/account/account_migration_service.js'
// 账户迁移格式转换回归：
...
jest.mock('../src/modules/account/account_claude_service.js', () => ({}))
jest.mock('../src/modules/account/account_claude_console_service.js', () => ({}))
jest.mock('../src/modules/account/account_ccr_service.js', () => ({}))
jest.mock('../src/modules/account/account_openai_service.js', () => ({}))
jest.mock('../src/modules/account/account_openai_responses_service.js', () => ({}))
jest.mock('../src/modules/account/account_gemini_service.js', () => ({}))
jest.mock('../src/modules/account/account_gemini_api_service.js', () => ({}))
jest.mock('../src/modules/account/account_azure_openai_service.js', () => ({}))
jest.mock('../src/modules/account/account_bedrock_service.js', () => ({}))
jest.mock('../src/modules/account/account_droid_service.js', () => ({}))
