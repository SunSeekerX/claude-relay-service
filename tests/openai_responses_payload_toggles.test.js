...
import { openaiResponsesRelayService } from '../src/modules/relay/relay_openai_responses_relay_service.js'
import openaiRoutes from '../src/modules/relay/relay_openai_routes.js'
...
jest.mock('../src/modules/relay/relay_unified_openai_scheduler.js', () => ({
...
jest.mock('../src/modules/relay/relay_openai_responses_relay_service.js', () => ({
...
jest.mock('../src/modules/proxy/proxy_helper.js', () => ({
  createProxyAgent: jest.fn(() => null),
  getProxyDescription: jest.fn(() => 'none')
}))

jest.mock('../src/modules/relay/relay_rate_limit_helper.js', () => ({
  updateRateLimitCounters: jest.fn()
}))

jest.mock('../src/modules/relay/relay_sse_parser.js', () => ({
...
jest.mock('../src/common/error_sanitizer.js', () => ({
