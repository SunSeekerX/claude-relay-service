...
jest.mock('../src/infra/redis.js', () => mockRedis)
jest.mock('../src/common/common_helper.js', () => ({ encrypt: jest.fn(), decrypt: jest.fn() }))
jest.mock('../src/common/logger.js', () => ({ warn: jest.fn(), error: jest.fn() }))
