...
import { claudeRelayConfigService } from '../src/modules/relay/relay_claude_relay_config_service.js'
...
jest.mock('../src/modules/relay/relay_claude_relay_config_service.js', () => ({
  getConfig: jest.fn()
}))
...
jest.mock('../src/modules/account/account_claude_service.js', () => ({ getAccount: jest.fn() }))
jest.mock('../src/modules/account/account_claude_console_service.js', () => ({ getAccount: jest.fn() }))
jest.mock('../src/modules/account/account_ccr_service.js', () => ({ getAccount: jest.fn() }))
jest.mock('../src/modules/account/account_gemini_service.js', () => ({ getAccount: jest.fn() }))
jest.mock('../src/modules/account/account_gemini_api_service.js', () => ({ getAccount: jest.fn() }))
jest.mock('../src/modules/account/account_openai_service.js', () => ({ getAccount: jest.fn() }))
jest.mock('../src/modules/account/account_openai_responses_service.js', () => ({
  getAccount: jest.fn()
}))
jest.mock('../src/modules/account/account_azure_openai_service.js', () => ({ getAccount: jest.fn() }))
jest.mock('../src/modules/account/account_droid_service.js', () => ({ getAccount: jest.fn() }))
jest.mock('../src/modules/account/account_bedrock_service.js', () => ({ getAccount: jest.fn() }))
