...
import { apiKeyIndexService } from '../src/modules/apikey/apikey_index_service.js'
...
jest.mock('../src/modules/relay/relay_request_detail_service.js', () => ({ captureRequestDetail: jest.fn() }))
jest.mock('../src/modules/payment/payment_billing_event_publisher.js', () => ({ publishBillingEvent: jest.fn() }))
jest.mock('../src/modules/pricing/pricing_cost_calculator.js', () => ({ calculateCost: jest.fn() }))
jest.mock('../src/modules/relay/relay_model_helper.js', () => ({ isClaudeFamilyModel: jest.fn(() => false) }))
