...
jest.mock('../src/modules/pricing/pricing_service.js', () => ({
...
describe('CostCalculator', () => {
  ...
  beforeEach(() => {
    ...
    pricingService = require('../src/modules/pricing/pricing_service.js')
    logger = require('../src/common/logger.js')
    CostCalculator = require('../src/modules/pricing/pricing_cost_calculator.js')
