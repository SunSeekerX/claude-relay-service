...
// 连接池配置（从环境变量读取）
const STREAM_MAX_SOCKETS = parseInt(env.HTTPS_MAX_SOCKETS_STREAM) || 65535
const NON_STREAM_MAX_SOCKETS = parseInt(env.HTTPS_MAX_SOCKETS_NON_STREAM) || 16384
const MAX_FREE_SOCKETS = parseInt(env.HTTPS_MAX_FREE_SOCKETS) || 2048
const FREE_SOCKET_TIMEOUT = parseInt(env.HTTPS_FREE_SOCKET_TIMEOUT) || 30000
