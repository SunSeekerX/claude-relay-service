...
import { ClaudeCodeValidator } from './validator_client_claude_code_validator.js'
import { GeminiCliValidator } from './validator_client_gemini_cli_validator.js'
import { CodexCliValidator } from './validator_client_codex_cli_validator.js'
import { DroidCliValidator } from './validator_client_droid_cli_validator.js'
import * as clientDefinitions from './validator_client_definitions.js'
/**
 * 客户端验证器
 * 用于验证请求是否来自特定的客户端
 */
...
// 客户端ID到验证器的映射表
const VALIDATOR_MAP = {
  [clientDefinitions.CLIENT_IDS.CLAUDE_CODE]: ClaudeCodeValidator,
  [clientDefinitions.CLIENT_IDS.GEMINI_CLI]: GeminiCliValidator,
  [clientDefinitions.CLIENT_IDS.CODEX_CLI]: CodexCliValidator,
  [clientDefinitions.CLIENT_IDS.DROID_CLI]: DroidCliValidator,
}
...
export class ClientValidator {
      ...
      try {
        if (validator.validate(req)) {
          ...
          return {
            ...
            clientInfo: clientDefinitions.getClientDefinitionById(clientId),
          }
        }
      } catch (error) {
  ...
  static getAvailableClients() {
    ...
    return clientDefinitions.getAllClientDefinitions()
  }
}
