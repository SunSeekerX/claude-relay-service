...
export const sub2apiToCrsSnapshot = function sub2apiToCrsSnapshot(acc, proxyByKey = {}) {
  ...
  if (platform === SUB2API_PLATFORM.OPENAI && (type === SUB2API_TYPE.API_KEY || type === SUB2API_TYPE.UPSTREAM)) {
