        ...
        do {
          ...
          for (let i = 0; i < entries.length; i++) {
            ...
            const cacheCreationTotal =
              ephemeral5mTokens > 0 || ephemeral1hTokens > 0 ? ephemeral5mTokens + ephemeral1hTokens : cacheCreateTokens
...
export const weeklyClaudeCostInitService = new WeeklyClaudeCostInitService()
