...
export const UPSTREAM_REASONS = new Set([
  'rate_limit',
  'overload',
  'service_unavailable',
  'timeout',
...
export const TOKEN_FAILURE_REASONS = new Set(['auth_error', 'token_refresh_failed'])
...
export const shouldClearOnEnable = (suspension) => Boolean(suspension) && suspension.source === 'auto'
