...
export const normalizeAntigravityModelInput = function normalizeAntigravityModelInput(
  model,
...
export const getAntigravityModelAlias = function getAntigravityModelAlias(modelName) {
...
export const getAntigravityModelMetadata = function getAntigravityModelMetadata(modelName) {
  const normalized = normalizeAntigravityModelInput(modelName)
...
export const mapAntigravityUpstreamModel = function mapAntigravityUpstreamModel(model) {
