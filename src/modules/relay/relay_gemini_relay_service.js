  ...
  try {
    ...
    if (error.response) {
      ...
      const errorObj = new Error(
        geminiError?.message || `Gemini countTokens API request failed (Status: ${error.response.status})`,
      )
