...
import { parseVendorPrefixedModel } from './relay_model_helper.js'
...
class CcrRelayService {
  ...
  async relayRequest(requestBody, apiKeyData, clientRequest, clientResponse, clientHeaders, accountId, options = {}) {
    ...
    try {
      ...
      if (clientResponse) {
        detachClientDisconnect = onClientDisconnect(clientResponse, handleClientDisconnect, 'CCR request')
      }
      ...
      if (line.startsWith('data: ')) {
        ...
        if (jsonData.usage) {
          return {
            ...
            cache_creation_input_tokens_ephemeral_5m: jsonData.usage.cache_creation_input_tokens_ephemeral_5m || 0,
            cache_creation_input_tokens_ephemeral_1h: jsonData.usage.cache_creation_input_tokens_ephemeral_1h || 0,
          }
        }
  ...
  _filterClientHeaders(clientHeaders) {
    ...
    const allowedHeaders = ['accept-language', 'anthropic-beta', 'anthropic-dangerous-direct-browser-access']
...
export const ccrRelayService = new CcrRelayService()
