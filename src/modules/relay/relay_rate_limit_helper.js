...
export const updateRateLimitCounters = async function updateRateLimitCounters(
  ...
  if (preCalculatedCost && typeof preCalculatedCost.ratedCost === 'number' && preCalculatedCost.ratedCost > 0) {
  ...
  } else if (preCalculatedCost && typeof preCalculatedCost.realCost === 'number' && preCalculatedCost.realCost > 0) {
