  ...
  try {
    ...
    if (sessionBindingErrorMessage !== undefined) {
      ...
      if (sessionBindingErrorMessage.length > 500) {
        return res.status(400).json({ error: 'sessionBindingErrorMessage must be less than 500 characters' })
      }
    }
    ...
    if (sessionBindingTtlDays !== undefined) {
      if (typeof sessionBindingTtlDays !== 'number' || sessionBindingTtlDays < 1 || sessionBindingTtlDays > 365) {
        return res.status(400).json({ error: 'sessionBindingTtlDays must be a number between 1 and 365' })
      }
    }
    ...
    if (userMessageQueueDelayMs !== undefined) {
      if (
        ...
        return res.status(400).json({ error: 'userMessageQueueDelayMs must be a number between 0 and 10000' })
      }
    }
    ...
    if (userMessageQueueTimeoutMs !== undefined) {
      if (
        ...
        return res.status(400).json({ error: 'userMessageQueueTimeoutMs must be a number between 1000 and 300000' })
      }
    }
    ...
    if (concurrentRequestQueueMaxSize !== undefined) {
      if (
        ...
        return res.status(400).json({ error: 'concurrentRequestQueueMaxSize must be an integer between 1 and 100' })
      }
    }
    ...
    if (concurrentRequestQueueTimeoutMs !== undefined) {
      if (
        ...
        return res.status(400).json({
          error: 'concurrentRequestQueueTimeoutMs must be an integer between 5000 and 300000 (5 seconds to 5 minutes)',
        })
      }
    }
