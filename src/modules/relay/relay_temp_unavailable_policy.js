...
export const normalizeOptionalNonNegativeInteger = (value) => {
...
export const normalizeTempUnavailablePolicyInput = (value = {}) => ({
  disableTempUnavailable: parseBooleanLike(value.disableTempUnavailable),
  tempUnavailable503TtlSeconds: normalizeOptionalNonNegativeInteger(value.tempUnavailable503TtlSeconds),
  tempUnavailable5xxTtlSeconds: normalizeOptionalNonNegativeInteger(value.tempUnavailable5xxTtlSeconds),
})

export const normalizeTempUnavailablePolicyFromAccountData = (accountData = {}) => {
