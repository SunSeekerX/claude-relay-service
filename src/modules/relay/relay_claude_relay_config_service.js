...
let _ccrAccountService = null
const getCcrAccountService = () => {
  if (!_ccrAccountService) {
    _ccrAccountService = require('../account/account_ccr_service.js').ccrAccountService
  }
  return _ccrAccountService
}

let _claudeConsoleAccountService = null
const getClaudeConsoleAccountService = () => {
  if (!_claudeConsoleAccountService) {
    _claudeConsoleAccountService = require('../account/account_claude_console_service.js').claudeConsoleAccountService
  }
  return _claudeConsoleAccountService
}

let _claudeAccountService = null
const getClaudeAccountService = () => {
  if (!_claudeAccountService) {
    _claudeAccountService = require('../account/account_claude_service.js').claudeAccountService
  }
  return _claudeAccountService
}

let _bedrockAccountService = null
const getBedrockAccountService = () => {
  if (!_bedrockAccountService) {
    _bedrockAccountService = require('../account/account_bedrock_service.js').bedrockAccountService
  }
  return _bedrockAccountService
}
    ...
    try {
      ...
      switch (accountType) {
        case 'claude-official':
          accountService = getClaudeAccountService()
          break
        case 'claude-console':
          accountService = getClaudeConsoleAccountService()
          break
        case 'bedrock':
          accountService = getBedrockAccountService()
          break
        case 'ccr':
          accountService = getCcrAccountService()
          break
        default:
      ...
      const autoOff = accountData.disableAutoProtection === true || accountData.disableAutoProtection === 'true'
...
export const claudeRelayConfigService = new ClaudeRelayConfigService()
