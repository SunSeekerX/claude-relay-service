...
const buildAntigravityQuota = function buildAntigravityQuota(modelsResponse) {
  ...
  const parseRemainingFraction = (quotaInfo) => {
    ...
    const raw = quotaInfo.remainingFraction ?? quotaInfo.remaining_fraction ?? quotaInfo.remaining ?? undefined
...
export class GeminiBalanceProvider extends BaseBalanceProvider {
  constructor() {
    super('gemini')
  }
